...
/**
 * Created by Prajwal on 26-03-2017.
 */
...
public class Help extends ActionBarActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        int[] drawableIds = {R.drawable.a1, R.drawable.a2, R.drawable.a3, R.drawable.a4, R.drawable.a6};
        ListView listView1;
...
// ,"View only Personal Tasks","View only Work based Tasks","Undo"